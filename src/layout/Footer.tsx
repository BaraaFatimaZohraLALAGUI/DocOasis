    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="md:flex md:justify-between">
          ...
          <Link to="/" className="block mb-4">
            ...
            <p className="mt-2 text-sm text-gray-600 max-w-md">
              Simplify your document management workflow with our secure, intuitive platform.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <div>
              ...
              <ul>
                <li className="mb-2">
                  <Link to="/about" className="text-sm text-gray-600 hover:text-blue-600">About</Link>
                </li>
                <li className="mb-2">
            ...
            <div>
              ...
              <ul>
                <li className="mb-2">
                  <Link to="/help" className="text-sm text-gray-600 hover:text-blue-600">Help Center</Link>
                </li>
                <li className="mb-2">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-gray-600">© 2023 DocOasis. All rights reserved.</p>
